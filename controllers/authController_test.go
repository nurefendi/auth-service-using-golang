...
func (f *fakeAuthUsecase) Me(c *fiber.Ctx) (dto.AuthUserResponse, *fiber.Error) { return dto.AuthUserResponse{}, nil }
func (f *fakeAuthUsecase) CheckAccess(c *fiber.Ctx, r dto.AuthCheckAccessRequest) *fiber.Error { return nil }
...
func (f *fakeAuthUsecaseErr) CheckUserNameExist(c *fiber.Ctx, userName *string) *fiber.Error { return nil }
func (f *fakeAuthUsecaseErr) Login(c *fiber.Ctx) *fiber.Error { return &fiber.Error{Code: fiber.StatusBadRequest, Message: "bad"} }
...
func (f *fakeAuthUsecaseErr) Me(c *fiber.Ctx) (dto.AuthUserResponse, *fiber.Error) { return dto.AuthUserResponse{}, nil }
func (f *fakeAuthUsecaseErr) CheckAccess(c *fiber.Ctx, r dto.AuthCheckAccessRequest) *fiber.Error { return nil }
func (f *fakeAuthUsecaseErr) MyAcl(c *fiber.Ctx) ([]dto.AuthUserFunction, *fiber.Error) { return nil, nil }
